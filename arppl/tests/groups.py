...
class GenerateGroupsCorrectly(unittest.TestCase):
    ...
    def test_get_group_1(self):
        rules = [
            # Group 1
            Rule(antecedent=[self.item_of_interest], consequent='attr2=2.5',
                 lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=['attr2=2.5'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.5, False)),

            # The first rule is irrelevant because of the lift value
            Rule(antecedent=[self.item_of_interest], consequent='attr2=2.5',
                 lift=MeasureIndependentlyAtOne(1.0, False)),
            Rule(antecedent=['attr2=2.5'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.5, False)),

            # Rules does not have the item of interest
            Rule(antecedent=['attr3=no'], consequent='attr2=2.5', lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=['attr2=2.5'], consequent='attr3=no', lift=MeasureIndependentlyAtOne(1.5, False)),

            # Rules does not have the item of interest
            Rule(antecedent=[self.item_of_interest], consequent='attr5=1', lift=MeasureIndependentlyAtOne(1.5, False)),
        ]
    ...
    def test_get_group_2(self):
        rules = [
            ...
            Rule(antecedent=['attr3=no'], consequent='attr2=2.5', lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=[self.item_of_interest], consequent='attr2=2.5',
                 lift=MeasureIndependentlyAtOne(1.2, False)),
            Rule(antecedent=[self.item_of_interest, 'attr3=no'], consequent='attr2=2.5',
                 lift=MeasureIndependentlyAtOne(1.6, False)),

            # The first rule is irrelevant because of the lift value
            Rule(antecedent=['attr4=no'], consequent='attr2=2.5', lift=MeasureIndependentlyAtOne(1.0, False)),
            Rule(antecedent=[self.item_of_interest], consequent='attr2=2.5',
                 lift=MeasureIndependentlyAtOne(1.5, False)),
            ...
            Rule(antecedent=['attr5=no'], consequent='attr3=2.5', lift=MeasureIndependentlyAtOne(1.3, False)),
            Rule(antecedent=[self.item_of_interest], consequent='attr3=2.5',
                 lift=MeasureIndependentlyAtOne(1.1, False)),
            Rule(antecedent=[self.item_of_interest, 'attr5=no'], consequent='attr3=2.5',
                 lift=MeasureIndependentlyAtOne(1.2, False)),

            # Rules does not have the item of interest
            Rule(antecedent=['attr5=yes'], consequent='attr3=2.5', lift=MeasureIndependentlyAtOne(1.1, False)),
            Rule(antecedent=['attr4=yes'], consequent='attr3=2.5', lift=MeasureIndependentlyAtOne(1.1, False)),
            Rule(antecedent=['attr4=yes', 'attr5=yes'], consequent='attr3=2.5',
                 lift=MeasureIndependentlyAtOne(1.2, False)),
        ]
    ...
    def test_get_group_3(self):
        rules = [
            ...
            Rule(antecedent=[self.item_of_interest], consequent='attr2=1.5',
                 lift=MeasureIndependentlyAtOne(1.2, False)),
    ...
    def test_get_group_4(self):
        rules = [
            ...
            Rule(antecedent=['attr5=yes'], consequent='attr2=1.5', lift=MeasureIndependentlyAtOne(1.2, False)),
            Rule(antecedent=[self.item_of_interest, 'attr5=yes'], consequent='attr2=1.5',
                 lift=MeasureIndependentlyAtOne(1.6, False)),

            # The first rule is irrelevant because of the lift value
            Rule(antecedent=[self.item_of_interest], consequent='attr2=5.5',
                 lift=MeasureIndependentlyAtOne(1.0, False)),
            ...
            # The less general rule has less lift than the most general
            Rule(antecedent=[self.item_of_interest], consequent='attr3=2.5',
                 lift=MeasureIndependentlyAtOne(1.3, False)),
            Rule(antecedent=[self.item_of_interest, 'attr5=no'], consequent='attr3=2.5',
                 lift=MeasureIndependentlyAtOne(1.2, False)),
    ...
    def test_get_group_6(self):
        rules = [
            # Group 6
            Rule(antecedent=['attr3=no'], consequent=self.item_of_interest, lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=['attr4=yes'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.3, False)),
            ...
            Rule(antecedent=['attr5=no'], consequent=self.item_of_interest, lift=MeasureIndependentlyAtOne(1.0, False)),
            Rule(antecedent=['attr6=yes'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.2, False)),
            Rule(antecedent=['attr5=no', 'attr6=yes'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.6, False)),

            # The less general rule has less lift than the most general
            Rule(antecedent=['attr7=no'], consequent=self.item_of_interest, lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=['attr8=yes'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.3, False)),
            Rule(antecedent=['attr7=no', 'attr8=yes'], consequent=self.item_of_interest,
                 lift=MeasureIndependentlyAtOne(1.2, False)),

            # Rules does not have the item of interest
            Rule(antecedent=['attr3=no'], consequent='attr2=h', lift=MeasureIndependentlyAtOne(1.5, False)),
            Rule(antecedent=['attr4=yes'], consequent='attr2=h', lift=MeasureIndependentlyAtOne(1.3, False)),
            Rule(antecedent=['attr3=no', 'attr4=yes'], consequent='attr2=h',
                 lift=MeasureIndependentlyAtOne(2.6, False)),
        ]
